...
export const UPDATE_PRODUCT_REQUEST = "GET_PRODUCT_DETAILS_REQUEST";
export const UPDATE_PRODUCT_SUCCESS = "GET_PRODUCT_DETAILS_SUCCESS";
export const UPDATE_PRODUCT_FAIL = "GET_PRODUCT_DETAILS_FAIL";
